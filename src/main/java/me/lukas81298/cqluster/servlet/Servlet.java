...
public class Servlet {
    ...
    public Servlet( int port, ClusterConnection clusterConnection, UserManager userManager, GroupManager groupManager ) throws IOException {
        ...
        httpServer.createContext( "/system/groups", new LayoutHtmlServer( new File( "html/groups.html" ) ) );
